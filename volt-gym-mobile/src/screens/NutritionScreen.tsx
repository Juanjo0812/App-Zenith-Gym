...
const MEAL_TYPES = [
  { key: 'desayuno', label: 'Desayuno', icon: 'free-breakfast' as const, color: '#FFB300' },
  { key: 'almuerzo', label: 'Almuerzo', icon: 'restaurant' as const, color: '#FF7043' },
  { key: 'cena', label: 'Cena', icon: 'dinner-dining' as const, color: '#7E57C2' },
  { key: 'snack', label: 'Merienda', icon: 'icecream' as const, color: '#26C6DA' },
  { key: 'otro', label: 'Otro', icon: 'fastfood' as const, color: '#78909C' },
];
      ...
      >
        ...
        <View style={styles.heroCard}>
          ...
          <View style={styles.quickStats}>
            ...
            <View style={styles.quickStat}>
              <MaterialCommunityIcons name="cup-water" size={18} color="#6FD8FF" />
        ...
        <View style={styles.card}>
          ...
          <View style={styles.track}>
            <View style={[styles.fill, { width: `${proteinProgress}%`, backgroundColor: '#00D9FF' }]} />
          </View>

          <Text style={styles.macroLabel}>Carbohidratos</Text>
          <Text style={styles.macroMeta}>{consumed.carbs} g de {carbsTarget} g</Text>
          <View style={styles.track}>
            <View style={[styles.fill, { width: `${carbsProgress}%`, backgroundColor: '#00E676' }]} />
          </View>

          <Text style={styles.macroLabel}>Grasas</Text>
          <Text style={styles.macroMeta}>{consumed.fats} g de {fatsTarget} g</Text>
          <View style={styles.track}>
            <View style={[styles.fill, { width: `${fatsProgress}%`, backgroundColor: '#FFB300' }]} />
          </View>
        </View>
        ...
        <View style={styles.card}>
          <View style={styles.rowBetween}>
            <View style={styles.row}>
              <MaterialCommunityIcons name="cup-water" size={22} color="#6FD8FF" />
          ...
          <View style={styles.track}>
            <View style={[styles.fill, { width: `${waterProgress}%`, backgroundColor: '#6FD8FF' }]} />
          </View>
        ...
        <View>
          ...
          {meals.length === 0 ? (
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptyText}>Toca el botón naranja para guardar tu primera comida del día.</Text>
            </View>
          ) : (
            meals.map((meal) => {
...
const styles = StyleSheet.create({
  ...
  waterValue: { fontSize: 18, fontWeight: '700', color: '#6FD8FF' },
  ...
  waterButtonText: { textAlign: 'center', fontSize: 13, fontWeight: '700', color: '#6FD8FF' },
  emptyState: {
    alignItems: 'center',
    paddingVertical: 32,
