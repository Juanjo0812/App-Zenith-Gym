...
SYSTEM_PROMPT_COACH = """Eres el entrenador personal con IA de Zenith. Tu nombre es Zenith Coach.
...
SYSTEM_PROMPT_GENERATE = """Eres un generador de rutinas de entrenamiento de Zenith.
