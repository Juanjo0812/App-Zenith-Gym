...
const CLASS_ACCENTS = [colors.accent, colors.success, colors.warning, colors.error];

const getClassAccent = (index: number) => CLASS_ACCENTS[index % CLASS_ACCENTS.length];
        ...
        {myEnrollments.length > 0 && (
          <View style={styles.section}>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              {myEnrollments.map((c, index) => (
                <View
                  key={c.id}
                  style={[styles.enrollmentChip, { borderColor: getClassAccent(index) }]}
                >
                  <View style={[styles.chipDot, { backgroundColor: getClassAccent(index) }]} />
                  <View>
              ...
              >
                ...
                <View
                  style={[
                    ...
                    { backgroundColor: getClassAccent(index) },
                  ]}
                />
