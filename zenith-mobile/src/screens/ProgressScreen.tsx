        ...
        <View style={styles.stateScreen}>
          <View style={styles.loadingState}>
            ...
            <Text style={styles.emptyText}>
              Estamos preparando tus métricas, logros y registros para mostrarte una vista completa.
            </Text>
          </View>
        </View>
      </SafeAreaView>
                          ...
                          <View
                            ...
                            styles.progressBarFillSm,
                            {
                              width: `${getProgress(challenge.current_value, challenge.goal_value)}%`,
                                backgroundColor: challenge.completed ? colors.success : colors.accent,
                            },
                          ]}
                        />
                        </View>
                ...
                {leaderboard.map((entry) => (
                  <View key={`${entry.rank}-${entry.name}`} style={styles.leaderboardRow}>
                    <Text
                      style={[
                        styles.rankText,
                        entry.rank <= 3 && { color: [colors.success, colors.warning, colors.textSecondary][entry.rank - 1] },
                      ]}
                    >
                      #{entry.rank}
                    </Text>
                ...
                strengthGains.map((gain) => (
                  <View key={gain.exercise_name} style={styles.gainCard}>
                    ...
                    <View style={styles.gainRow}>
                      ...
                      <MaterialIcons name="arrow-right-alt" size={20} color={colors.success} />
...
const styles = StyleSheet.create({
  ...
  challengeXp: { color: colors.success, fontSize: 12, fontWeight: '700' },
  ...
  badgeIconUnlocked: { borderWidth: 2, borderColor: colors.accentBorder },
  ...
  badgeXp: { color: colors.success, fontSize: 10, fontWeight: '700', marginTop: 4 },
  leaderboardHeader: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 10,
  ...
  userXpText: { color: colors.accent, fontWeight: '700', fontSize: 14 },
  ...
  chartBar: { width: 14, backgroundColor: colors.success, borderRadius: 7, marginVertical: 6 },
  ...
  gainCurrent: { color: colors.success, fontSize: 15, fontWeight: '700' },
  gainPctBadge: {
  ...
  gainPctText: { color: colors.success, fontSize: 11, fontWeight: '700' },
